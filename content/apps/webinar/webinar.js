...
var chance = Chance();
var $stock = $("#main-gen");
$.getJSON("webinar.json", function (data) {
    quantity = 1;
...
function random_text() {
    var arr = ["בדיוק מכינים", "אנחנו עובדים על הדבר החם הבא", "איזה כיף יהיה ב...", "בזמנים קשים כאלה בואו להרגע עם",
        "הגיע הזמן ללמוד",
        "נצלו את הבידוד להתמחות ב...",
        "בואו ללמוד מהמומחים שלנו",
        "זה תואר ללא תואר ב...",
        "בואו להיות מומחים עם...",
        "הוציאו מעצמכם יותר",
        "מרחיבים את סט הכישורים שלכם עם..."
    ];
